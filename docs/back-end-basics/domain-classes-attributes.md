...
| **Attribute** | **Description** |
| --- | --- |
| `[Audited]`                                     | Identifies fields whose changes should be logged for easy tracking of when the change was made and the user responsible for that change. When used on the class level, all properties of that entity will be audited. See also [audit logging](/docs/manage-apps-and-users/audit-logging). |
