...
| `Person` | Represents a person in the application such as employee, customer, contact, etc... A Person is not necessarily a system user as this will depend on wether there is a corresponding `User` for Person. See also ([User management fundamentals](/docs/fundamentals/user-management)). |
| `Note` | Represents a user note or comment. A list of notes may be associated with any parent entity. See also [notes fundamentals](/docs/fundamentals/notes.md). |
| `ReferenceList` and `ReferenceListItem` | Represents a standard list of values. See also [reference lists](/docs/back-end-basics/reference-lists.md). |
...
/// </summary>
[ReferenceList("MyOrg.TicketManagement", "TicketStatus")]   // The ReferenceList attribute is used to indicate that this enum is a reference list see [Reference Lists](/docs/back-end-basics/reference-lists.md) for more details.
...
### See Also:
* [Reference Lists](/docs/back-end-basics/reference-lists.md)
* [Domain Class Attributes](/docs/fundamentals/domain-class-attributes.md)
* 