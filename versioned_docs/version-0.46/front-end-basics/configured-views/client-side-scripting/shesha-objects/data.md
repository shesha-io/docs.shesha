...
This takes in all the properties that just have a [property name](../../../form-components/common-component-properties.md#property-name-string), or an empty **context** property.
