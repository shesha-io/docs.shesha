...
The following properties are available to configure the behavior of the File component from the form editor (this is in addition to [common properties](../common-component-properties.md)).
...
The Font, Dimensions, Border, Background, Shadow, Margin & Padding, and Style settings on this tab work the same way as described in the [common properties](../common-component-properties.md). File List adds two extra sub-panels that are unique to this component, documented below as their own sections.
...
The Container Styles panel also contains its own Dimensions, Margin & Padding, and Custom Style (Style script) controls, which apply to the container rather than the component as a whole. These work the same way as the equivalent controls described in the [common properties](../common-component-properties.md).
...
The Font and Custom Styles controls inside this panel work the same way as the equivalent controls described in the [common properties](../common-component-properties.md), but only apply once a file has been downloaded.
