...
Front-end validation prevents typos and accidental bad input. It does not stop a determined user from posting bad data directly to the API. Always pair front-end validation with server-side validation for any rule that matters - see the [Validation](../fundamentals/validation.md) page for the back-end side.
:::
