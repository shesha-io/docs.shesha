...
If your module also contains domain classes, specify the [database prefix](../back-end-basics/domain-model.md#module-database-prefix) by adding the following lines to the `AssemblyInfo.cs` file:
