...
This guide walks through the full process of implementing a custom configuration item type on Shesha v0.46.
...
For detailed guidance on building forms, refer to the [Form Components](../front-end-basics/form-components/common-component-properties.md) documentation.
