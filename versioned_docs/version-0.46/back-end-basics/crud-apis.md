...
| specifications | List [specifications](../fundamentals/specifications.md) to apply. |
...
To enforce validation and other business logic on Create and Update operations use [Fluent Validation](../fundamentals/validation.md#applying-validation-on-auto-generated-crud-apis).

### Customizing Querying behavior on QueryAll end-point

To 'inject' custom querying logic into the generated QueryAll end-point you implement [Specifications](../fundamentals/specifications.md).
...
- [Custom APIs](./custom-apis.md)
- [Validation](../fundamentals/validation.md)
- [Specifications](../fundamentals/specifications.md)
