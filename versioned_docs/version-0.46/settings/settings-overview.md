...
- The [default endpoint access](../fundamentals/security/endpoint-permissions.md) used when an API endpoint's access is set to "Inherited"
...
- **Permissions:** Appropriate permissions for viewing and interacting with the menu item. Detailed information is available in the [Permission Based Security Model](../manage-apps-and-users/permission-based-model.md) article.
