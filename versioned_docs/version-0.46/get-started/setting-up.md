...
- **The .NET 10 SDK**, which the backend targets.
- **Visual Studio** in a version that supports .NET 10, for the backend. The Community edition is fine.
- **Visual Studio Code** for the frontend.
- **Node.js 24 or later** (with npm 11 or later) installed and available on your PATH.
:::
...
The backend is an ASP.NET Core solution, targeting .NET 10, that you open and run in Visual Studio.

1. Open the starter project folder.
2. Navigate to the `backend` folder.
3. Double-click `Shesha.Membership.sln` (or the equivalent name for your project) to open it in Visual Studio.
...
4. Confirm Node.js 24 or later is installed:
