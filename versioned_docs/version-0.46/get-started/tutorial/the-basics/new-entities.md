...
See [CRUD APIs](../../../back-end-basics/crud-apis.md) for what each endpoint does and how to customise the generated set.
...
2. Drag a **DataTable Context** (see the [DataTable Context reference](../../../front-end-basics/form-components/tables-lists/datatable-context.md)) onto the form, below the existing **details** panel.
...
3. Drag a **DataTable** (see the [DataTable reference](../../../front-end-basics/form-components/tables-lists/datatable.md)) onto the panel.
...
Inline editing lets users add payments directly into the table without opening a separate dialog. See the [inline editing how-to](../../../front-end-basics/how-to-guides/inline-editing.md) for the full flow.
...
| Component | Purpose |
|---|---|
| [Quick Search](../../../front-end-basics/form-components/tables-lists/quick-search.md) | Free-text filter across columns. |
| [Table Pager](../../../front-end-basics/form-components/tables-lists/table-pager.md) | Paging controls. |
| [Table View Selector](../../../front-end-basics/form-components/tables-lists/table-view-selector.md) | Switches between named filters. |
