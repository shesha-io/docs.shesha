...
| `Node.js` | 24 or later | If you have a different version installed, use [nvm](https://github.com/nvm-sh/nvm) to switch between versions without conflicts. |
| `npm` | 11 or later | Comes with Node.js. |
| `Next.js` | 16.3.x | Installed automatically via `npm install`. |
...
| `.NET` | 10.0 | The framework runs on .NET 10. |
