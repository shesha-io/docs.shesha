...
This section appears once you have selected an **Entity Type**. It controls which records the picker can search and select from, how the selected value is stored, and which columns appear in the picker's selection list.
